...
temp_data <- data[c('gender','age','class','embarked','fare','sibsp','parch')]
    ...
    dashboardSidebar(
        sidebarMenu(
            ...
            pickerInput(
              ...
              choices = c('gender','age','class','embarked','fare','sibsp','parch'),
              selected = c('gender','age'),
              options = list(
                `actions-box` = TRUE,
                size = 12,
